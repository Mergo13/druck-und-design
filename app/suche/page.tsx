...
export default async function SearchPage({ searchParams }: { searchParams?: Promise<{ q?: string; kategorie?: string }> }) {
  ...
  return (
    <section className="container-page py-10">
      ...
      <div className="mt-8"><ShopBrowser initialCategory={initialCategory} initialQuery={initialQuery} categories={categories} products={products} authenticated={authenticated} /></div>
    </section>
  );
}
