...
export default function AboutPage() {
  return (
    <>
      <PageHero eyebrow="Über Uns" title="Druckproduktion trifft digitale Produktlogik" text="Wir verbinden europäische Produktionsqualität mit einer modernen Plattform für Konfiguration, Upload, Freigabe und Nachbestellung." />
